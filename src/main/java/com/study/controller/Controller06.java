...
public class Controller06 {
    ...
    // /main6/sub2
    // /main6/sub2?abc=lee&qwe=24
    @RequestMapping("sub2")
    public void method2(@RequestParam(value = "abc", required = false) String param1,
                        @RequestParam(value = "qwe", required = false) String param2) {
    ...
    // /main6/sub3?name=lee
    // /main6/sub3?age=33
    // /main6/sub3?name=%EA%B9%80%EB%AF%BC%EC%9E%AC&age=24
    @RequestMapping("sub3")
    ...
    // /main6/sub7?name=흥민&age=77 //method param
    // /main6/sub7?age=66
    // /main6/sub7?name=강인
    // /main6/sub7

    // method argument 타입이 기본타입(wrapper 포함) String(의 배열)=> 이면
    // @RequestParam 으로 간주됨
    @RequestMapping("sub7")
    public void method7(String name, Integer age) { // method argument
        System.out.println("name = " + name);
        System.out.println("age = " + age);
    }
