...
public class Controller14 {
    ...
    public void sub2(Model model) {
        ...
        // attribute 명은
        // 클래스명을 lowerCamelCase 결정
        // 좋은 습관은 이름을 직접 작성하는 것이다.
    ...
    public String sub5(MyBean142 o1) {
        ...
        o1.setName("유재석");
        return "/main14/sub3";  // /WEB-INF/view/main14/sub3 로 포워드
    }
    ...
    @RequestMapping("sub7")
    public String string(MyBean143 o1) {
    ...
    // /main14/sub9?name=흥민&age=33&address=london
    @RequestMapping("sub9")
    ...
    // /main14/sub10?name=강인&age=23&address=파리
