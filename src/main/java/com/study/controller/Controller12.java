...
//        model.addAttribute("age", 33);    //성인용 other
    ...
    public void method4(Model model) {
        ...
        model.addAttribute("myList2", List.of("java", "css", "react"));

        model.addAttribute("myMap2", Map.of("my", "first"));
    }
    ...
    public void method7(Model model) {
        ...
        MyBean122 e2 = new MyBean122("김하성", "샌디에고", "한국", "야구", List.of("유격수", "2투수"));
        MyBean122 e3 = new MyBean122("오타니", "LA", "일본", "야구", List.of("투수", "지명타자"));
        MyBean122 e4 = new MyBean122("이강인", "파리", "한국", "축구", List.of("미드필더"));
        MyBean122 e5 = new MyBean122("김민재", "뮌헨", "한국", "축구", List.of("센터백"));
